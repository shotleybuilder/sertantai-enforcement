...
docker build -t ghcr.io/yourusername/ehs-enforcement:latest .

# Test locally (optional)
docker run -p 4002:4002 --env-file .env.local ghcr.io/yourusername/ehs-enforcement:latest

# Push to registry
docker push ghcr.io/yourusername/ehs-enforcement:latest
```
...
docker build -t ghcr.io/yourusername/ehs-enforcement:$VERSION .
docker build -t ghcr.io/yourusername/ehs-enforcement:latest .

# Push both tags
docker push ghcr.io/yourusername/ehs-enforcement:$VERSION
docker push ghcr.io/yourusername/ehs-enforcement:latest
```
