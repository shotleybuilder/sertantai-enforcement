defmodule EhsEnforcementWeb.Admin.CaseLive.EaProgressUnitTest do
  ...
  describe "EA vs HSE Progress field comparison" do
    test "EA progress excludes HSE-specific fields" do
      ea_fields = [
        :cases_found, :cases_created, :cases_updated, :cases_exist_total, :errors_count, :status
      ]
      
      hse_only_fields = [
        :pages_processed, :current_page, :max_pages, :cases_created_current_page, :cases_updated_current_page, :cases_exist_current_page
      ]
