defmodule EhsEnforcementWeb.Admin.CaseLive.EaRecordsDisplayTest do
  ...
  describe "EA Records Display" do
    ...
    test "EA processing logs appear in Records table via PubSub", %{conn: conn} do
      ...
      assert has_element?(view, "span", "Batch 1") # EA shows "Batch" not "Page"
      
      # Should show the case statistics
      assert has_element?(view, "span", "3") # items_found
      assert has_element?(view, "span", "1") # items_created  
      assert has_element?(view, "span", "2") # items_existing
    ...
    test "Records table distinguishes between HSE pages and EA batches", %{conn: conn} do
      ...
      hse_log_params = %{
        ...
        agency: :hse,
        batch_or_page: 2,  # This is a page number for HSE
        items_found: 5,
        items_created: 3,
        items_existing: 2,
        items_failed: 0,
      ...
      ea_log_params = %{
        ...
        agency: :ea,
        batch_or_page: 1,  # This is a batch number for EA
        items_found: 2,
        items_created: 0,
        items_existing: 2, 
        items_failed: 0,
      ...
      assert has_element?(view, "span", "Page 2")  # HSE shows "Page"
      assert has_element?(view, "span", "Batch 1") # EA shows "Batch"
