defmodule EhsEnforcement.Enforcement.AgencyAutoPopulationTest do
  ...
  describe "agency auto-population" do
    ...
    test "creating a case automatically updates offender agencies", %{agency: agency, offender: offender} do
    ...
    test "creating a notice automatically updates offender agencies", %{agency: agency, offender: offender} do
      # Verify offender starts with empty agencies
      assert offender.agencies == []
    ...
    test "multiple enforcement actions from same agency don't duplicate", %{agency: agency, offender: offender} do
