defmodule EhsEnforcement.Agencies.Ea.DataTransformerTest do
  ...
  def complete_ea_record do
    %{
      ...
      address: "  123 Test Street  ",  # Test address normalization
  ...
  def nil_heavy_ea_record do
    %{
      ...
      offender_name: nil,  # Should not crash clean_company_name/1
      address: nil,        # Should not crash normalize_address/1
      action_date: ~D[2025-08-01],
      action_type: :court_case,
      ...
      offence_description: "Test offence",  # Required field
      offence_type: "Test offence type",    # Required field
      case_reference: nil,
      event_reference: nil,
      agency_function: nil,
      water_impact: nil,
  ...
  def address_test_record do
    %{
      ...
      address: "  Test Address  ",  # Should be normalized
      action_date: ~D[2025-08-01],
      action_type: :court_case,
      total_fine: Decimal.new(0),
  ...
  def company_name_test_record do
    %{
      ...
      offender_name: "  Test Company Ltd  ",  # Should be normalized
  ...
  describe "EA data transformation" do
    test "transform_ea_record/1 handles complete EA record" do
      ...
      assert transformed[:regulator_id] == "EA/CC/2025/001"  # Uses case_reference when provided
      assert transformed[:offender_name] == "Test Company Ltd"
      assert transformed[:address] == "123 Test Street"  # Normalized (trimmed)
    ...
    test "transform_ea_record/1 handles nil values safely" do
      ...
      assert is_binary(transformed[:regulator_id])  # Should generate ID even with nil values
    end
    ...
    test "normalize_address/1 handles various input types" do
      ...
      assert result_valid[:address] == "Test Address"  # Trimmed spaces
    ...
    test "clean_company_name/1 handles various input types" do
      ...
      assert result_valid[:offender_name] == "Test Company Ltd"  # Trimmed spaces
