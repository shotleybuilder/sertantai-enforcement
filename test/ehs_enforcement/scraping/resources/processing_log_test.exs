defmodule EhsEnforcement.Scraping.ProcessingLogTest do
  ...
  describe "ProcessingLog resource structure" do
    ...
    test "session_id is required and string type" do
      session_id_attr =
        ProcessingLog.__ash_config__(:attributes)
  ...
  describe "ProcessingLog actions" do
    test "has create action with correct accept list" do
      create_action =
        ProcessingLog.__ash_config__(:actions)
  ...
  describe "EA compatibility (replacing EaCaseProcessingLog)" do
    ...
    test "rejects invalid string batch_or_page values from EA scraping" do
      ...
      invalid_ea_data = %{
        ...
        agency: :ea,
        # This exact string causes the error
        batch_or_page: "court_case_batch",
        items_found: 5,
        items_created: 3,
        items_existing: 1,
        items_failed: 1,
    ...
    test "accepts correct integer batch_or_page values from EA scraping after fix" do
      ...
      fixed_ea_data = %{
        ...
        agency: :ea,
        # FIXED: Now correctly using integer
        batch_or_page: 1,
        items_found: 5,
        items_created: 3,
        items_existing: 1,
  ...
  describe "Query capabilities" do
    test "can filter by session_id using for_session action" do
      ...
      {:ok, session_1_logs} =
        Ash.read(ProcessingLog, action: :for_session, session_id: "session_1")
