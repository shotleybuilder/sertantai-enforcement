defmodule EhsEnforcement.Scraping.Hse.CaseProcessorTest do
  ...
  describe "create_cases/2" do
    ...
    test "prevents duplicate cases from being created" do
      ...
      assert {:ok, existing_cases} = Enforcement.list_cases(filter: [regulator_id: "HSE_DUPLICATE_TEST"])
      assert length(existing_cases) == 1
      
      # Attempt to create the same case again - should be skipped
      duplicate_case = %ProcessedCase{
        regulator_id: "HSE_DUPLICATE_TEST",  # Same regulator_id
        agency_code: :hse,  
        offender_attrs: %{name: "Different Company Name"},  # Different details, but same ID
        offence_action_date: ~D[2023-02-20],
        offence_action_type: "Court Case"
      }
      ...
      assert {:ok, all_cases} = Enforcement.list_cases(filter: [regulator_id: "HSE_DUPLICATE_TEST"])
    ...
    test "handles mixed new and duplicate cases correctly" do
      ...
      mixed_cases = [
        %ProcessedCase{
          regulator_id: "HSE_EXISTING",  # This is a duplicate
          agency_code: :hse,
        ...
        %ProcessedCase{
          regulator_id: "HSE_NEW_001",  # This is new
          agency_code: :hse,
        ...
        %ProcessedCase{
          regulator_id: "HSE_NEW_002",  # This is new
          agency_code: :hse,
