defmodule EhsEnforcementWeb.ContactLive do
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
      <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="prose prose-lg text-gray-700 space-y-6">
          <p>
            We'd love to hear from you. Get in touch with us for support, feedback, or general inquiries.
          </p>
            ...
            <div>
              ...
              <div class="mt-8 p-4 bg-blue-50 rounded-lg">
                ...
                <p class="text-sm text-blue-700 mb-3">
                  Check our <.link navigate={~p"/support"} class="underline hover:text-blue-800">Support page</.link> 
                  for frequently asked questions and troubleshooting guides.
                </p>
                <p class="text-sm text-blue-700">
                  For technical documentation, visit our <.link navigate={~p"/docs"} class="underline hover:text-blue-800">Documentation</.link> section.
                </p>
              </div>
            </div>
          </div>
