      ...
      <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="prose prose-lg text-gray-700 space-y-6">
          ...
          <ul class="list-disc pl-6 space-y-2">
            <li><strong>Dashboard:</strong> Overview of recent enforcement activity and key statistics</li>
            <li><strong>Cases:</strong> Search and view enforcement cases with detailed information</li>
            <li><strong>Notices:</strong> Browse improvement and prohibition notices</li>
            <li><strong>Offenders:</strong> View organizations that have received enforcement actions</li>
          ...
          <p>
            If you need assistance using the platform, please visit our <.link navigate={~p"/support"} class="text-blue-600 hover:text-blue-800 underline">Support page</.link> 
            or <.link navigate={~p"/contact"} class="text-blue-600 hover:text-blue-800 underline">contact us</.link> directly.
          </p>
        </div>
      </div>
    </div>
