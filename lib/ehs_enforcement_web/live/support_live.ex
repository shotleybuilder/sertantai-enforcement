          ...
          <div class="space-y-6">
            ...
            <div class="border-l-4 border-blue-400 bg-blue-50 p-4">
              ...
              <p class="text-gray-700">
                ...
                access to our data, please <.link navigate={~p"/contact"} class="text-blue-600 hover:text-blue-800 underline">contact us</.link> 
            ...
            <div class="border-l-4 border-blue-400 bg-blue-50 p-4">
              <h3 class="font-semibold text-gray-900 mb-2">Can I request specific data or features?</h3>
              <p class="text-gray-700">
                We welcome feedback and feature requests. Please <.link navigate={~p"/contact"} class="text-blue-600 hover:text-blue-800 underline">contact us</.link> 
          ...
          <div class="grid md:grid-cols-2 gap-6">
            <div class="bg-gray-50 rounded-lg p-6">
              ...
              <p class="text-gray-700 mb-3">
                Check our comprehensive <.link navigate={~p"/docs"} class="text-blue-600 hover:text-blue-800 underline">documentation</.link> 
            ...
            <div class="bg-gray-50 rounded-lg p-6">
              <h3 class="font-semibold text-gray-900 mb-3 flex items-center">
                <svg class="h-5 w-5 text-blue-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 7.89a1 1 0 001.41 0L21 7M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                </svg>
                Direct Contact
              </h3>
              <p class="text-gray-700 mb-3">
                Still need help? <.link navigate={~p"/contact"} class="text-blue-600 hover:text-blue-800 underline">Send us a message</.link> 
            ...
            <div class="flex">
              ...
              <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-green-700">
                  <p>All systems operational. Data last updated: <span class="font-medium">Today</span></p>
                </div>
              </div>
            </div>
          </div>
